...
public  class viewtraffic extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewtraffic);
    ...
    public void Findroutes(LatLng Start, LatLng End)
    {
        if(Start==null || End==null) {
            Toast.makeText(viewtraffic.this,"Unable to get location",Toast.LENGTH_LONG).show();
        }
        else
        {
...
//        Findroutes(start,end);
    ...
    public void onRoutingStart() {
        Toast.makeText(viewtraffic.this,"Finding Route...",Toast.LENGTH_LONG).show();
    }
